...
public class ResultActivity extends AppCompatActivity {
    ...
    private void processResult() {
        ...
        result.setText(getResources().getString(resultTextId));
        int resultColorId = isWin ? R.color.green : R.color.red;
        result.setTextColor(getResources().getColor(resultColorId));

        TextView description = findViewById(R.id.description);
        int descriptionId = isWin ? R.string.description_win : R.string.description_lose;
        String desc = getResources().getString(descriptionId);
